...
class WishlistsControllerTest < ActionController::TestCase
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post :create, wishlist: { brand: @wishlist.brand, name: @wishlist.name, price: @wishlist.price, url: @wishlist.url }
    end
  ...
  test "should update wishlist" do
    patch :update, id: @wishlist, wishlist: { brand: @wishlist.brand, name: @wishlist.name, price: @wishlist.price, url: @wishlist.url }
    assert_redirected_to wishlist_path(assigns(:wishlist))
  end
